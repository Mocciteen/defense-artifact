...
macro(find_llvm use_llvm)
  ...
  if(LLVM_LIBS) # check if defined, not if it is true
    ...
    foreach(__flag IN ITEMS ${__llvm_libfiles})
      ...
      if(IS_ABSOLUTE "${__lib_with_prefix}" AND NOT EXISTS "${__lib_with_prefix}")
        message(WARNING "Skipping missing LLVM library reported by llvm-config: ${__lib_with_prefix}")
      else()
